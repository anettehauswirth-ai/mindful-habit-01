...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Stillness — Mindfulness Habit Tracker" },
      { name: "twitter:description", content: "An elegant daily mindfulness practice tracker." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/5939d375-4d68-4881-9d96-205e34e6fd62" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/5939d375-4d68-4881-9d96-205e34e6fd62" },
    ],
